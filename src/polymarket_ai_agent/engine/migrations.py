...
Migrations live in ``src/polymarket_ai_agent/migrations/`` as
...
class MigrationRunner:
    def __init__(
        self,
        db_path: Path,
        migrations_pkg: str = "polymarket_ai_agent.migrations",
    ):
    ...
    def _load_migration_module(stem: str, path: Path) -> ModuleType:
        ...
        """
        safe_name = "polymarket_ai_agent_migrations_" + stem.replace("-", "_")
